...
SECRET_KEY = 'django-insecure-8w%s2epdpv3oy*kpjohj%rld)5sny3cfd$7x+u0#-@=9v^fb6o'
...
# config/settings.py (Add this at the very bottom)
...
# JWT Settings (Optional but good for "Pro" control)
SIMPLE_JWT = {
